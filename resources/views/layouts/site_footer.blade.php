			...
			<div class="row footer_matter">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="footer_logo_wrapper">
						<!-- <img src="{{asset('site/image/logo/logo.png')}}" alt="footer_logo" class="img-responsive wow fadeInDown animated"> -->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="footer_list_wrapper">
						...
						<ul class="footer_list">
							<li class="wow fadeInDown animated"><a href="{{route('about')}}"><i class="fa fa-angle-right" aria-hidden="true"></i> About Us</a>
							</li>
							<!-- <li class="wow fadeInDown animated"><a href="services.html"><i class="fa fa-angle-right" aria-hidden="true"></i> Our Services </a>
							</li> -->
							<li class="wow fadeInDown animated"><a href="{{route('products')}}"><i class="fa fa-angle-right" aria-hidden="true"></i> Products List </a>
							</li>
							<li class="wow fadeInDown animated"><a href="{{route('cart')}}"><i class="fa fa-angle-right" aria-hidden="true"></i> Cart</a>
							</li>
							<li class="wow fadeInDown animated"><a href="{{route('checkout')}}"><i class="fa fa-angle-right" aria-hidden="true"></i> Checkout </a> </li>
							<li class="wow fadeInDown animated"><a href="{{route('blogs')}}"><i class="fa fa-angle-right" aria-hidden="true"></i> Blogs </a> </li>
							<li class="wow fadeInDown animated"><a href="{{route('contact')}}"><i class="fa fa-angle-right" aria-hidden="true"></i> Contact Us </a> </li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="download_wrapper">
						...
						<div class="download_btn_wrapper">
						  <a href="#">
							<img src="{{asset('site/image/App-Store.png')}}" class="img-responsive wow fadeInDown animated" alt="App_Store_img">
						  </a>
						  <a href="#">
							<img src="{{asset('site/image/Google-Play.png')}}" class="img-responsive wow fadeInDown animated" alt="Google_Play_img">
						  </a>
						</div>
					</div>
				</div>
